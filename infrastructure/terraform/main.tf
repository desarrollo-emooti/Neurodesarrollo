# EMOOTI AWS Infrastructure - Main Configuration
# =============================================
...
terraform {
  ...
  backend "s3" {
    bucket = "emooti-terraform-state"
    key    = "emooti/terraform.tfstate"
    region = "eu-west-1"
  }
}
  ...
  container_definitions = jsonencode([
    {
      ...
      image = "${var.aws_account_id}.dkr.ecr.${var.aws_region}.amazonaws.com/${local.name_prefix}-repo:latest"
