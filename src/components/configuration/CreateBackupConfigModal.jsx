...
export default function CreateBackupConfigModal({ open, onClose, onSuccess }) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await apiClient.configuration.createBackupConfiguration({
        name: data.name.trim(),
      ...
      toast.success('Configuración de backup creada correctamente');
      reset();
      onSuccess();
      onClose();
    } catch (error) {
      ...
      toast.error(
        error.response?.data?.error?.message || 'Error al crear la configuración de backup'
      );
    } finally {
      setSubmitting(false);
    }
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Nueva Configuración de Backup
          </DialogTitle>
          <DialogDescription>
            Crea una configuración para respaldos automáticos del sistema
          </DialogDescription>
        </DialogHeader>
