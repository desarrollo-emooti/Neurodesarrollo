...
export default function CreateInventoryModal({ open, onClose, onSuccess }) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await apiClient.inventory.create(itemData);
      ...
      toast.error(error.response?.data?.error?.message || 'Error al crear item');
    } finally {
      setLoading(false);
    }
  };
